...
export default function Menu(): JSX.Element {
    ...
    return (
        <>
            <div className={['Menu', 'bg-primary', 'relative', 'p-4', 'flex', 'w-full', 'h-full', 'md:w-[640px]', 'md:h-fit', 'm-auto', 'md:shadow-lg', 'md:rounded', 'justify-center', 'align-center', 'items-center', 'text-center'].join(' ')}>
                {((page) => {
                    switch(page) {
